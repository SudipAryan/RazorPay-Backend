package com.sudip.razorpay.vault.service.impl;
...
import com.sudip.razorpay.vault.config.VaultEncryptionConfig;
import com.sudip.razorpay.vault.dto.request.TokenizeRequest;
import com.sudip.razorpay.vault.dto.response.TokenizeResponse;
import com.sudip.razorpay.vault.entity.CardToken;
import com.sudip.razorpay.vault.entity.VaultCard;
import com.sudip.razorpay.vault.repository.CardTokenRepository;
import com.sudip.razorpay.vault.repository.VaultCardRepository;
...
public class VaultServiceImpl implements VaultService {
    ...
    public PaymentProcessorResponse charge(UUID paymentId,String token,
        ...
        try {
            ...
            return new PaymentProcessorResponse.Failure("VAULT_CHARGE", e.getMessage());
        }
        finally {

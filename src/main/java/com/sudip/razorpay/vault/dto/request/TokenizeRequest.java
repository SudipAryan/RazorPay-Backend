package com.sudip.razorpay.vault.dto.request;

import com.sudip.razorpay.vault.validation.ExpiryYear;
...
public record TokenizeRequest(
        ...
        @LuhnCheck(message = "Invalid card Number")// TODO: Learn About this

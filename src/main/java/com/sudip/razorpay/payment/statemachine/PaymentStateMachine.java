...
import com.sudip.razorpay.common.exceptions.InvalidStateTransitionException;
...
public class PaymentStateMachine {
    ...
    private static final Map<Transition, PaymentStatus> TRANSITION =  Map.ofEntries(
            ...
            Map.entry(new Transition(PaymentStatus.CAPTURING, PaymentEvent.CAPTURE_SUCCESS), PaymentStatus.CREATED),
